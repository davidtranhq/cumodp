...
ln -sf $CUMODP_HOME/src/$PROJECT_NAME/bigArithmeticKernels_P4.cu $CUMODP_HOME/src/bigArithmeticKernels_P4.cu

ln -sf $CUMODP_HOME/src/bigArithmeticKernels_P4.cu $PROJECT/src/bigArithmeticKernels.cuh
