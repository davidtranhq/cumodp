...
cd $dataPath
if [ ! -e "xData_cuda_"$operation"_"$iteration"_"$shuffle"_"$padding ];then
	printf "********************************\n"
	printf "\n--: "xData_cuda_"$operation"_"$iteration"_"$shuffle"_"$padding doesn't exist!\n"
	printf "********************************\n"
	exit
fi
...
diff -q "xData_cuda_"$operation"_"$iteration"_"$shuffle"_"$padding "xData_cuda_"$operation"_"$iteration"_0_"$padding
diff -s "xData_cuda_"$operation"_"$iteration"_"$shuffle"_"$padding "xData_cuda_"$operation"_"$iteration"_0_"$padding
printf "\n****************************************************************\n"
