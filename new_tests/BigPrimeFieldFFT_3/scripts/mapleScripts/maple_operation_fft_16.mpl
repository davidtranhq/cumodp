...
writeFile:=fopen("../../test/tmp/uData_maple_4",WRITE, TEXT):
...
# writeFile:=fopen("uData_maple_fft16",WRITE,TEXT):
...
# compute FFT16 over vector of big integers, of size 16
result:=FFT16(xN, 16, omega, p):
