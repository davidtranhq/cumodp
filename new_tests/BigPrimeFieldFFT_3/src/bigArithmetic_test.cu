...
main (int argc, char *argv[])
{
	...
	//data must be located in CUMODP_HOME/new_tests/BigPrimeFieldFFT_3/test/data/
	char x_path[1024];
	char y_path[1024];

	sprintf (
			x_path,
			"/home/dave/Desktop/FFT/repository/modpn/cumodp/new_tests/BigPrimeFieldFFT_3/test/data/data_2_11_22_1m/xData");
	sprintf (y_path, "output.txt");
	usfixn32 e = 2; //FFT of size K^e
