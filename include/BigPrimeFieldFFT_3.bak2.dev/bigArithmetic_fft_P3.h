...
/**********************************************/
__device__ void
device_p3_bigPrimeAdd_correct_local_fft(usfixn64 *xm, usfixn64 *ym, usfixn64 *um)
{
	unsigned short c = 0;
	short pos1;
	usfixn64 num1, num2;
...
device_p3_bigPrimeAdd_plain_local_fft (usfixn64 *__restrict__ xm, usfixn64 *__restrict__ ym)
{
	unsigned short c = 0;
	short pos1;
	usfixn64 num1, num2;
...
/**********************************************/
__device__ __inline__ void
device_p3_bigPrimeAdd_plain_inPlace_local_fft (usfixn64 * __restrict__ xm,
...
device_p3_fft16_plain (usfixn64 *xsm, usfixn64 *ysm)
{
	...
	{
		//bigAdd
		device_p3_bigPrimeAdd_correct_local_fft(&xf[wpid * 8], &xf[(wpid + 8) * 8],
																	 &yf[wpid * 8]);
	}
	__syncthreads ();
	if (sf)
	...
	{
		//bigAdd
		device_p3_bigPrimeAdd_correct_local_fft(&xf[posid * 8], &xf[(posid + 4) * 8],
																	 &yf[posid * 8]);
	}
	__syncthreads ();
	if (sf)
	...
	{
		//bigAdd
		device_p3_bigPrimeAdd_correct_local_fft(&xf[posid * 8], &xf[(posid + 2) * 8],
																	 &yf[posid * 8]);
	}
	__syncthreads ();
	if (sf)
	...
	{
		//bigAdd
		device_p3_bigPrimeAdd_correct_local_fft(&xf[posid * 8], &xf[(posid + 1) * 8],
																	 &yf[posid * 8]);
	}
	__syncthreads ();
...
//	device_p3_fft_base2_permutated(&xm[idx], &xm[idx+8], permutationStride);
	...
	device_p3_bigPrimeAdd_plain_local_fft (x, y);
...
//				device_cyclicShift_permutated_12 (complement);
			if (signVector[offset] == 1)
			{
				device_p3_bigPrimeAdd_plain_inPlace_local_fft (v0.i, complement);
...
//		device_p3_bigPrimeAdd_plain_local_fft (v0.i, v1.i);
		device_p3_bigPrimeAdd_plain_inPlace_local_fft (v0.i, v1.i);
...
//
////	device_p3_bigPrimeAdd_plain_local_fft(v1.i, v2_sub.i);
////	device_p3_bigSub_plain(v0_sub.i, v1.i);
//	device_p3_bigPrimeSub_plain_inPlace (v0_sub.i, v1.i);
//
//	offset = tid;
...
//		offset += permutationStride;
//	}
//	device_p3_bigPrimeAdd_plain_local_fft (v0_sub.i, v1.i);
//
//	offset = tid;
////positive c's [2:7]
////	memset(v1.i, 0x00, 8 * sizeof(usfixn64));
...
kernel_p3_fft16_plain_singleThread (usfixn64 *xs, usfixn64 *ys)
{
	...
	//first round
	//0  8
	device_p3_bigPrimeAdd_correct_local_fft(&xd[0], &xd[64], &yd[0]);
	device_p3_bigSub (&xd[0], &xd[64], &yd[64]);
	//4  12
	device_p3_bigPrimeAdd_correct_local_fft(&xd[32], &xd[96], &yd[32]);
	device_p3_bigSub (&xd[32], &xd[96], &yd[96]);
	//2  10
	device_p3_bigPrimeAdd_correct_local_fft(&xd[16], &xd[80], &yd[16]);
	device_p3_bigSub (&xd[16], &xd[80], &yd[80]);
	//6  14
	device_p3_bigPrimeAdd_correct_local_fft(&xd[48], &xd[112], &yd[48]);
	device_p3_bigSub (&xd[48], &xd[112], &yd[112]);
	//1  9
	device_p3_bigPrimeAdd_correct_local_fft(&xd[8], &xd[72], &yd[8]);
	device_p3_bigSub (&xd[8], &xd[72], &yd[72]);
	//5  13
	device_p3_bigPrimeAdd_correct_local_fft(&xd[40], &xd[104], &yd[40]);
	device_p3_bigSub (&xd[40], &xd[104], &yd[104]);
	//3  11
	device_p3_bigPrimeAdd_correct_local_fft(&xd[24], &xd[88], &yd[24]);
	device_p3_bigSub (&xd[24], &xd[88], &yd[88]);
	//7  15
	device_p3_bigPrimeAdd_correct_local_fft(&xd[56], &xd[120], &yd[56]);
	...
	//second round
	//0 4
	device_p3_bigPrimeAdd_correct_local_fft(&xd[0], &xd[32], &yd[0]);
	device_p3_bigSub (&xd[0], &xd[32], &yd[32]);
	//8 12
	device_p3_cyclicShift (&xd[96], 4);
	device_p3_bigPrimeAdd_correct_local_fft(&xd[64], &xd[96], &yd[64]);
	device_p3_bigSub (&xd[64], &xd[96], &yd[96]);

	//2  6
	device_p3_bigPrimeAdd_correct_local_fft(&xd[16], &xd[48], &yd[16]);
	device_p3_bigSub (&xd[16], &xd[48], &yd[48]);
	//10 14
	device_p3_cyclicShift (&xd[112], 4);
	device_p3_bigPrimeAdd_correct_local_fft(&xd[80], &xd[112], &yd[80]);
	device_p3_bigSub (&xd[80], &xd[112], &yd[112]);

	//1 5
	device_p3_bigPrimeAdd_correct_local_fft(&xd[8], &xd[40], &yd[8]);
	device_p3_bigSub (&xd[8], &xd[40], &yd[40]);
	//9 13
	device_p3_cyclicShift (&xd[104], 4);
	device_p3_bigPrimeAdd_correct_local_fft(&xd[72], &xd[104], &yd[72]);
	device_p3_bigSub (&xd[72], &xd[104], &yd[104]);

	//3  7
	device_p3_bigPrimeAdd_correct_local_fft(&xd[24], &xd[56], &yd[24]);
	device_p3_bigSub (&xd[24], &xd[56], &yd[56]);
	//11  15
	device_p3_cyclicShift (&xd[120], 4);
	device_p3_bigPrimeAdd_correct_local_fft(&xd[88], &xd[120], &yd[88]);
	...
	//third round
	//0 2
	device_p3_bigPrimeAdd_correct_local_fft(&xd[0], &xd[16], &yd[0]);
	device_p3_bigSub (&xd[0], &xd[16], &yd[16]);

	//8 10
	device_p3_cyclicShift (&xd[80], 2);
	device_p3_bigPrimeAdd_correct_local_fft(&xd[64], &xd[80], &yd[64]);
	device_p3_bigSub (&xd[64], &xd[80], &yd[80]);

	//4 6
	device_p3_cyclicShift (&xd[48], 4);
	device_p3_bigPrimeAdd_correct_local_fft(&xd[32], &xd[48], &yd[32]);
	device_p3_bigSub (&xd[32], &xd[48], &yd[48]);

	//12 14
	device_p3_cyclicShift (&xd[112], 6);
	device_p3_bigPrimeAdd_correct_local_fft(&xd[96], &xd[112], &yd[96]);
	device_p3_bigSub (&xd[96], &xd[112], &yd[112]);

	//1 3
	device_p3_bigPrimeAdd_correct_local_fft(&xd[8], &xd[24], &yd[8]);
	device_p3_bigSub (&xd[8], &xd[24], &yd[24]);

	//9 11
	device_p3_cyclicShift (&xd[88], 2);
	device_p3_bigPrimeAdd_correct_local_fft(&xd[72], &xd[88], &yd[72]);
	device_p3_bigSub (&xd[72], &xd[88], &yd[88]);

	//5 7
	device_p3_cyclicShift (&xd[56], 4);
	device_p3_bigPrimeAdd_correct_local_fft(&xd[40], &xd[56], &yd[40]);
	device_p3_bigSub (&xd[40], &xd[56], &yd[56]);

	//13 15
	device_p3_cyclicShift (&xd[120], 6);
	device_p3_bigPrimeAdd_correct_local_fft(&xd[104], &xd[120], &yd[104]);
	...
	//fourth
	//0 1
	device_p3_bigPrimeAdd_correct_local_fft(&xd[0], &xd[8], &yd[0]);
	device_p3_bigSub (&xd[0], &xd[8], &yd[8]);

	//8 9
	device_p3_cyclicShift (&xd[72], 1);
	device_p3_bigPrimeAdd_correct_local_fft(&xd[64], &xd[72], &yd[64]);
	device_p3_bigSub (&xd[64], &xd[72], &yd[72]);

	//4 5
	device_p3_cyclicShift (&xd[40], 2);
	device_p3_bigPrimeAdd_correct_local_fft(&xd[32], &xd[40], &yd[32]);
	device_p3_bigSub (&xd[32], &xd[40], &yd[40]);

	//12 13
	device_p3_cyclicShift (&xd[104], 3);
	device_p3_bigPrimeAdd_correct_local_fft(&xd[96], &xd[104], &yd[96]);
	device_p3_bigSub (&xd[96], &xd[104], &yd[104]);

	//2 3
	device_p3_cyclicShift (&xd[24], 4);
	device_p3_bigPrimeAdd_correct_local_fft(&xd[16], &xd[24], &yd[16]);
	device_p3_bigSub (&xd[16], &xd[24], &yd[24]);

	//10 11
	device_p3_cyclicShift (&xd[88], 5);
	device_p3_bigPrimeAdd_correct_local_fft(&xd[80], &xd[88], &yd[80]);
	device_p3_bigSub (&xd[80], &xd[88], &yd[88]);

	//6 7
	device_p3_cyclicShift (&xd[56], 6);
	device_p3_bigPrimeAdd_correct_local_fft(&xd[48], &xd[56], &yd[48]);
	device_p3_bigSub (&xd[48], &xd[56], &yd[56]);

	//14 15
	device_p3_cyclicShift (&xd[120], 7);
	device_p3_bigPrimeAdd_correct_local_fft(&xd[112], &xd[120], &yd[112]);
