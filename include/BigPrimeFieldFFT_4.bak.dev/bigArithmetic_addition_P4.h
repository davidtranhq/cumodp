// for 16-word prime
#ifndef BIG_ARITHMETIC_ADDITION_H_
#define BIG_ARITHMETIC_ADDITION_H_
...
/******************************************************************************/
//
//__device__ void bigPrimeAdd_correct_improved1(usfixn64 * __restrict__ xm,
...
/******************************************************************************/
//
//__device__ void bigPrimeAddStepped_correct(usfixn64 *xm, usfixn64 *ym,
...
//__device__ void bigPrimeAdd_permutated(usfixn64 *xm, usfixn64 *ym, usfixn64 *um)
//{
//
////	short pos1;
////	usfixn64 num1, num2;
...
/******************************************************************************/
//__device__ void bigPrimeAdd_permutated_2(const usfixn64 __restrict__ * xm,
...
//}
/******************************************************************************/
//__device__ void bigPrimeAdd_permutated_3(const usfixn64 __restrict__ * xm,
//		const usfixn64 * __restrict__ ym, usfixn64 *__restrict__ um,
//		const usfixn64 idx, const short permutationStride)
//{
...
//
////using vectorized data structure + offset is computed more efficiently
//__device__ void device_fft2_permutated_5(usfixn64 * __restrict__ xm,
...
/****************************************************/
__global__ void
kernel_p4_addition_plain (usfixn64 * xs, usfixn64 * ys, usfixn64 *parameters)
...
//	device_bigPrimeAdd_plain(xd, yd);
	...
	device_bigPrimeAdd_plain_ptx_v0 (xd, yd);
...
/****************************************************/
__global__ void
kernel_p4_addition_permutated (usfixn64 *xs, usfixn64 *ys, usfixn64 *parameters)
{
	short operation = parameters[0];
	...
	idx = tid;
//	if (padding == 0)
	device_bigPrimeAdd_permutated_ptx_v0 (&xs[idx], &ys[idx], permutationStride);
